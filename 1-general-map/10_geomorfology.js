...
// get collection 
var classification = ee.Image('users/dh-conciani/collection7/c7-general-post/CERRADO_col7_gapfill_incidence_temporal_frequency_spatial_perturbance_v5');
...
Export.image.toAsset({
    'image': recipe,
    'description': 'CERRADO_col7_gapfill_incidence_temporal_frequency_spatial_perturbance_geomorfology_v5',
    'assetId': 'users/dh-conciani/collection7/c7-general-post/CERRADO_col7_gapfill_incidence_temporal_frequency_spatial_perturbance_geomorfology_v5',
    'pyramidingPolicy': {
        '.default': 'mode'
    },
