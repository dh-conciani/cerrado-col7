...
// define output
var output = 'users/dh-conciani/collection7/sample/points/';
...
var stablePixels = ee.Image('users/dh-conciani/collection7/masks/cerrado_stablePixels_1985_2020_v1')
...
var regionsCollection = ee.FeatureCollection('users/dh-conciani/collection7/sample/area/2000_v3');
...
var getTrainingSamples = function (feature) {
  ...
  var training = referenceMap.stratifiedSample(
                                {'scale': 30,
                                 ...
                                 'geometries': true,
                                 'classValues': classes,
                                 'classPoints': [n_forest, n_savanna, n_grassland, n_pasture,
